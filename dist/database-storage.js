...
ORDER BY B.createdat DESC; `;
    ...
    async updateProduct(id, updates) {
        try {
            ...
            const bestSellerValue = updates.isBestSeller ?? updates.isbestseller;
  ...
  `;
    ...
    async processOrderPlacement(orderData, userId) {
        try {
            ...
            const createdOrder = await this.createOrderWithTransaction(validation.validatedOrder, orderData.couponCode, userId);
            return {
                isValid: true,
                order: createdOrder,
